...
* List versions of dependences you are using: Flipt, Node, OS, etc.
* List the contents of your Flipt features.yml file.
...
Join our [Discord](https://www.flipt.io/discord) to chat with the team about any feature ideas or open a [Discussion](https://github.com/flipt-io/flipt/discussions) on the main Flipt GitHub repository.
